...
class SchoolControllerTest {
  ...
  void getSchoolsFull_ShouldThrowException_WhenSemesterIdDoesNotExist() {
    ...
    IllegalArgumentException exception = assertThrows(
      ...
      () ->
        schoolController.getSchoolsFull(
          null,
          null,
          semesterID,
          "name",
  ...
  void getSchoolsFull_ShouldResolveSemesterId_FromSemesterName() {
    ...
    when(semesterService.getByName(semesterName)).thenReturn(
      new Semester(semesterID, semesterName)
    );

    when(schoolService.getSchool(null, semesterID, "name", "asc")).thenReturn(
  ...
  void getSpecificSchool_ShouldThrowException_WhenSchoolNotFound() {
    ...
    when(schoolService.getById(schoolId)).thenThrow(
