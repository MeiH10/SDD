                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col items-center mr-4 w-8">
                        <button
                            ...
                            className={`transition-colors ${!isLoggedIn
                    ...
                    <div className="flex flex-col items-center justify-center ml-4 space-y-2">
                        ...
                        <button
                            ...
                            className={`p-2 transition-colors rounded-full hover:bg-gray-700/50 ${isDownloading
                                    ? "text-gray-600 cursor-not-allowed"
                                    : "text-gray-400 hover:text-teal-500"
                                }`}
                            title="Download"
                        ...
                        <button
                            ...
                            disabled={!isLoggedIn}
                            className={`p-2 transition-colors rounded-full hover:bg-gray-700/50 ${isLoggedIn
                                    ? "text-gray-400 hover:text-red-500"
                                    : "text-gray-600 cursor-not-allowed"
                                }`}
